...
## File Version: 0.08
## File Last Change: 2017-09-19 15:05:05
# Generated by using Rcpp::compileAttributes() -> do not edit by hand
# Generator token: 10BE3573-1514-4C36-9D1C-5A225CD40393

bifie_jack_timss <- function(wgt, jkzone, jkrep, RR, jkfac, prbar) {
    .Call('_BIFIEsurvey_bifie_jack_timss', PACKAGE = 'BIFIEsurvey', wgt, jkzone, jkrep, RR, jkfac, prbar)
}

bifie_boot <- function(cumwgt, rand_wgt) {
    .Call('_BIFIEsurvey_bifie_boot', PACKAGE = 'BIFIEsurvey', cumwgt, rand_wgt)
}

bifie_bifiedata2bifiecdata <- function(datalistM, Nimp) {
    .Call('_BIFIEsurvey_bifie_bifiedata2bifiecdata', PACKAGE = 'BIFIEsurvey', datalistM, Nimp)
}

bifie_bifiecdata2bifiedata <- function(datalistM_ind, datalistM_imputed, Nimp, dat1, datalistM_impindex) {
    .Call('_BIFIEsurvey_bifie_bifiecdata2bifiedata', PACKAGE = 'BIFIEsurvey', datalistM_ind, datalistM_imputed, Nimp, dat1, datalistM_impindex)
}

bifie_bifiedata_stepwise <- function(dat1, dat_ind, Nmiss) {
    .Call('_BIFIEsurvey_bifie_bifiedata_stepwise', PACKAGE = 'BIFIEsurvey', dat1, dat_ind, Nmiss)
}
...
bifie_linreg <- function(datalist, wgt1, wgtrep, dep_index, pre_index, fayfac, NI, group_index1, group_values) {
    .Call('_BIFIEsurvey_bifie_linreg', PACKAGE = 'BIFIEsurvey', datalist, wgt1, wgtrep, dep_index, pre_index, fayfac, NI, group_index1, group_values)
}

bifie_waldtest <- function(parsM, parsrepM, Cdes, rdes, Ccols, fayfac) {
    .Call('_BIFIEsurvey_bifie_waldtest', PACKAGE = 'BIFIEsurvey', parsM, parsrepM, Cdes, rdes, Ccols, fayfac)
}
...
bifie_logistreg <- function(datalist, wgt1, wgtrep, dep_index, pre_index, fayfac, NI, group_index1, group_values, eps, maxiter) {
    .Call('_BIFIEsurvey_bifie_logistreg', PACKAGE = 'BIFIEsurvey', datalist, wgt1, wgtrep, dep_index, pre_index, fayfac, NI, group_index1, group_values, eps, maxiter)
}
...
bifie_pathmodel <- function(datalist, wgt1, wgtrep, vars_index, fayfac, NI, group_index1, group_values, L, L_row_index, NL, E, R, R_row_index, coeff_index, NP0, unreliability) {
    .Call('_BIFIEsurvey_bifie_pathmodel', PACKAGE = 'BIFIEsurvey', datalist, wgt1, wgtrep, vars_index, fayfac, NI, group_index1, group_values, L, L_row_index, NL, E, R, R_row_index, coeff_index, NP0, unreliability)
}

bifie_replication_variance <- function(pars, pars_repl, fay_factor) {
    .Call('_BIFIEsurvey_bifie_replication_variance', PACKAGE = 'BIFIEsurvey', pars, pars_repl, fay_factor)
}

bifie_rubin_rules <- function(estimates, variances) {
    .Call('_BIFIEsurvey_bifie_rubin_rules', PACKAGE = 'BIFIEsurvey', estimates, variances)
}
