...
//// File Version: 0.14
//// File Last Change: 2017-09-19 15:05:07
...
RcppExport SEXP _BIFIEsurvey_bifie_jack_timss(SEXP wgtSEXP, SEXP jkzoneSEXP, SEXP jkrepSEXP, SEXP RRSEXP, SEXP jkfacSEXP, SEXP prbarSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(bifie_jack_timss(wgt, jkzone, jkrep, RR, jkfac, prbar));
    return rcpp_result_gen;
END_RCPP
}
// bifie_boot
Rcpp::List bifie_boot(Rcpp::NumericVector cumwgt, Rcpp::NumericMatrix rand_wgt);
RcppExport SEXP _BIFIEsurvey_bifie_boot(SEXP cumwgtSEXP, SEXP rand_wgtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(bifie_boot(cumwgt, rand_wgt));
    return rcpp_result_gen;
END_RCPP
}
// bifie_bifiedata2bifiecdata
Rcpp::List bifie_bifiedata2bifiecdata(Rcpp::NumericMatrix datalistM, int Nimp);
RcppExport SEXP _BIFIEsurvey_bifie_bifiedata2bifiecdata(SEXP datalistMSEXP, SEXP NimpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(bifie_bifiedata2bifiecdata(datalistM, Nimp));
    return rcpp_result_gen;
END_RCPP
}
...
RcppExport SEXP _BIFIEsurvey_bifie_bifiecdata2bifiedata(SEXP datalistM_indSEXP, SEXP datalistM_imputedSEXP, SEXP NimpSEXP, SEXP dat1SEXP, SEXP datalistM_impindexSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(bifie_bifiecdata2bifiedata(datalistM_ind, datalistM_imputed, Nimp, dat1, datalistM_impindex));
    return rcpp_result_gen;
END_RCPP
}
// bifie_bifiedata_stepwise
Rcpp::List bifie_bifiedata_stepwise(Rcpp::NumericMatrix dat1, Rcpp::NumericMatrix dat_ind, int Nmiss);
RcppExport SEXP _BIFIEsurvey_bifie_bifiedata_stepwise(SEXP dat1SEXP, SEXP dat_indSEXP, SEXP NmissSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type dat1(dat1SEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(bifie_bifiedata_stepwise(dat1, dat_ind, Nmiss));
    return rcpp_result_gen;
END_RCPP
}
...
Rcpp::NumericVector bifie_replication_variance(Rcpp::NumericVector pars, Rcpp::NumericMatrix pars_repl, Rcpp::NumericVector fay_factor);
RcppExport SEXP _BIFIEsurvey_bifie_replication_variance(SEXP parsSEXP, SEXP pars_replSEXP, SEXP fay_factorSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(bifie_replication_variance(pars, pars_repl, fay_factor));
    return rcpp_result_gen;
END_RCPP
}
// bifie_rubin_rules
Rcpp::List bifie_rubin_rules(Rcpp::NumericMatrix estimates, Rcpp::NumericMatrix variances);
RcppExport SEXP _BIFIEsurvey_bifie_rubin_rules(SEXP estimatesSEXP, SEXP variancesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(bifie_rubin_rules(estimates, variances));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_BIFIEsurvey_bifie_jack_timss", (DL_FUNC) &_BIFIEsurvey_bifie_jack_timss, 6},
    {"_BIFIEsurvey_bifie_boot", (DL_FUNC) &_BIFIEsurvey_bifie_boot, 2},
    {"_BIFIEsurvey_bifie_bifiedata2bifiecdata", (DL_FUNC) &_BIFIEsurvey_bifie_bifiedata2bifiecdata, 2},
    {"_BIFIEsurvey_bifie_bifiecdata2bifiedata", (DL_FUNC) &_BIFIEsurvey_bifie_bifiecdata2bifiedata, 5},
    {"_BIFIEsurvey_bifie_bifiedata_stepwise", (DL_FUNC) &_BIFIEsurvey_bifie_bifiedata_stepwise, 3},
    ...
    {"_BIFIEsurvey_bifie_replication_variance", (DL_FUNC) &_BIFIEsurvey_bifie_replication_variance, 3},
    {"_BIFIEsurvey_bifie_rubin_rules", (DL_FUNC) &_BIFIEsurvey_bifie_rubin_rules, 2},
    {NULL, NULL, 0}
};
