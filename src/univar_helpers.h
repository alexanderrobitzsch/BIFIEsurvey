...
//// File Version: 7.15
//// File Last Change: 2017-08-27 14:44:38
...
Rcpp::List mla2_postproc( int N , int NX , int NZ , Rcpp::NumericVector y ,
    ...
    return Rcpp::List::create( 
       _["totmean_yX"] = totmean_yX , _["Sigma_B_yX"] = Sigma_B_yX ,
       _["Sigma_W_yX"] = Sigma_W_yX ,
       _["totmean_yZ"] = totmean_yZ , _["Sigma_B_yZ"] = Sigma_B_yZ ,
       _["Sigma_W_yZ"] = Sigma_W_yZ   ,
       _["vardec"] = vardec , _["fvcov"] = fvcov
                    ) ;  
